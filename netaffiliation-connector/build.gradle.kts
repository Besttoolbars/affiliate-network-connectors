...
bintray {
    ...
    pkg(delegateClosureOf<BintrayExtension.PackageConfig> {
        repo = "repo"
        name = "netaffiliation-connector"
        userOrg = "besttoolbars"
        websiteUrl = "https://github.com/Besttoolbars/affiliate-network-connectors/netaffiliation-connector"
        ...
        description = "Kwanko affiliate connector"
        setLabels("kotlin", "jvm", "netaffiliation")
