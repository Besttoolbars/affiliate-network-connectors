...
bintray {
    ...
    pkg(delegateClosureOf<BintrayExtension.PackageConfig> {
        repo = "repo"
        name = "afilio-connector"
        userOrg = "besttoolbars"
        websiteUrl = "https://github.com/Besttoolbars/affiliate-network-connectors/afilio-connector"
        ...
        description = "Afilio connector"
        setLabels("kotlin", "jvm", "afilio")
